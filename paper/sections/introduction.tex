...
After introducing the most important background concepts concerning this work in Section 2, Section 3 explains the terrain classifier implementation challenges and the solutions applied. 
